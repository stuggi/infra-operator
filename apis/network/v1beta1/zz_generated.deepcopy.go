...
func (in *NetConfigStatus) DeepCopyInto(out *NetConfigStatus) {
	*out = *in
	if in.Reservations != nil {
		...
		*out = make(map[string]NetReservation, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetReservation) DeepCopyInto(out *NetReservation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetReservation.
func (in *NetReservation) DeepCopy() *NetReservation {
	if in == nil {
		return nil
	}
	out := new(NetReservation)
	in.DeepCopyInto(out)
	return out
}
