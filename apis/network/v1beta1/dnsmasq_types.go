...
const (
	...
	// DNSDataLabelSelector - label selector to identify config maps with hosts data
	DNSDataLabelSelector = "dnsmasqhosts"
)
...
type DNSMasqSpec struct {
	...
	// TODO create its own container image
	...
	// Value of the DNSDataLabelSelector which was set on the configmaps containing hosts information
...
func (instance DNSMasq) IsReady() bool {
	ready := instance.Status.ReadyCount > 0
