...
require (
	...
	github.com/metallb/frr-k8s v0.0.22
...
// pin frr-k8s to a version compatible with k8s v0.33 and go 1.24
replace github.com/metallb/frr-k8s => github.com/metallb/frr-k8s v0.0.22 //allow-merging
...
// pin gnostic-models to v0.6.9 to avoid go.yaml.in/yaml/v3 vs gopkg.in/yaml.v3 type mismatch with kube-openapi
