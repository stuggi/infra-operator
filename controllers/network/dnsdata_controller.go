...
// generateServiceConfigMaps - create create configmap hosts file
func (r *DNSDataReconciler) generateServiceConfigMaps(
	...
	cmLabels := labels.GetLabels(instance, labels.GetGroupLabel(dnsmasq.ServiceName), map[string]string{dnsmasq.DNSDataLabelSelector: strings.ToLower(instance.Spec.DNSDataLabelSelectorValue)})
