...
# openstack.org/infra-operator-bundle:$VERSION and openstack.org/infra-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/$(USER)/infra-operator
...
GOTOOLCHAIN_VERSION ?= go1.22.12+auto
